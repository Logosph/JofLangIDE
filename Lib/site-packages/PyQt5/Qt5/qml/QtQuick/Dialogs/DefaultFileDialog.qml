...
AbstractFileDialog {
    ...
    function acceptSelection() {
        // transfer the MainWindow's selections to QQuickFileDialog
        clearSelection()
        ...
        SplitView {
            ...
            TableView {
                ...
                TableViewColumn {
                    ...
                    // something like textFormat: function(text) { return MainWindow.model.get(styleData.row, "fileIsDir") ? "folder" : text }
                    delegate: Item {
