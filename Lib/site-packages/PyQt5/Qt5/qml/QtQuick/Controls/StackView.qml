...
/*!
    ...
    StackView {
        ...
        Component {
            ...
            MouseArea {
                ...
                onClicked: stack.push(MainWindow)
            }
        }
    }
    \endqml
    ...
    \note Items pushed onto the stack MainWindow have \l{Supported Attached Properties}{Stack attached properties}.
    ...
    \list
        ...
        \li \l{Stack::MainWindow}{Stack.MainWindow} - Contains the StackView the item is in
