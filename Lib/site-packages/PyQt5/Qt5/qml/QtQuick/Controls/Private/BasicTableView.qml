...
ScrollView {
    ...
    /*! \qmlproperty bool BasicTableView::alternatingRowColors
        ...
        This property is set to \c true if the MainWindow alternates the row color.
    ...
    */
    ...
    /*! \qmlproperty bool BasicTableView::sortIndicatorVisible
        ...
        \note The MainWindow itself does not sort the data.
    */
    ...
    */
    ...
    /*!
        ...
        This enum indicates how the MainWindow responds to user selections:
        ...
        Component {
            ...
            FocusScope {
                ...
                Loader {
                    ...
                    // Row fills the MainWindow width regardless of item size
